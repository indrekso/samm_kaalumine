...
#| tbl-cap: "Vähemalt kolme võõrkeelt oskavate elanike osakaal koos elanike arvuga vanusegrupis 18--64 aastat 2022. aastal"
...
lang_pop |> 
  ...
  tab_source_note(md("*Allikas: Eurostat*")) |> 
  opt_interactive()
```
