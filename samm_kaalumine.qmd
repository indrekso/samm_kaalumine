...
Peatüki aluseks olev repositoorium koos täieliku R-i koodi ja andmetega on leitav [siit](https://github.com/indrekso/samm_kaalumine.git).
...
gr10 |> 
  ...
  # funktsioon weighted.mean nõuab argumenti na.rm = TRUE, et arvutusest jäetaks välja indiviidid, kellel esineb tunnuses stfhlth andmelünk
```
